...
// Github - username
export const Github_UserName = "sanjeevk11";
export const Github_Repository_Name = "Foodfire=App";

// Github API for User
export const Github_API_User = "https://api.github.com/users/";

// Social Media Links
export const Linkedin_Link = "https://www.linkedin.com/in/sanjeev-kumar-201bb620b/";
export const Twitter_Link = "";
export const Github_Link = "https://github.com/sanjeevk11";
export const Email_Link = "mailto:sanjeevk1128@gmail.com";
